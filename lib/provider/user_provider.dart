...
import 'package:gamersmultiverse/db/order.dart';
import 'package:gamersmultiverse/db/users.dart';
...
// import 'dart:async';
//
// import 'package:projectscd/db/users.dart';
// import 'package:cloud_firestore/cloud_firestore.dart';
// import 'package:flutter/material.dart';
// import 'package:flutter/widgets.dart';
// import 'package:firebase_auth/firebase_auth.dart';
...
//         _firestore.collection('users').doc().set({  //need to add user.uid
//           'name':name,
//           'email':email,
//           'uid':user,
//         });
